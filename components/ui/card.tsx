  ...
  return (
    <div
      ...
      className={cn(
        ...
        "gap-4 overflow-hidden py-4 text-sm",
...
function CardHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "gap-1.5 px-5 pt-1 group-data-[size=sm]/card:px-4",
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "border-t px-5 py-4 group-data-[size=sm]/card:px-4 group-data-[size=sm]/card:py-3",
